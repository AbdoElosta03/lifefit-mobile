...
class ExpertDetailsScreen extends StatefulWidget { // حولناها لـ StatefulWidget للتحكم في الاختيار
  final String name;
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(widget.specialty, style: const TextStyle(color: Color(0xFF00D9D9), fontSize: 16, fontWeight: FontWeight.w600)),
                const SizedBox(height: 15),
                Row(
                ...
                Text(widget.bio, textAlign: TextAlign.right, style: TextStyle(color: Colors.grey[600], fontSize: 14, height: 1.6)),
                const SizedBox(height: 25),
                _buildSectionHeader('باقات الاشتراك'),
                
                // قائمة الباقات القابلة للاختيار
                _buildPriceCard(0, 'باقة الشهر الواحد', '150 د.ل', 'أفضل لتجربة الخدمة'),
                _buildPriceCard(1, 'باقة 3 أشهر', '400 د.ل', 'خصم 15% - الأكثر طلباً'),
                _buildPriceCard(2, 'باقة السنة كاملة', '1200 د.ل', 'وفر 600 د.ل سنوياً'),
  ...
  Widget _buildCircularProfileImage() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFF00D9D9).withOpacity(0.2), width: 2),
      ),
  ...
  Widget _buildPriceCard(int index, String title, String price, String note) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xFF00D9D9).withOpacity(0.05) : Colors.white,
          ...
          boxShadow: isSelected ? [
            BoxShadow(color: const Color(0xFF00D9D9).withOpacity(0.1), blurRadius: 10, offset: const Offset(0, 4))
          ] : [],
        ),
        child: Row(
          children: [
            ...
            Text(price, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF00D9D9))),
            const Spacer(),
            Column(
    ...
    return Align(
      ...
      child: Container(
        ...
        child: ElevatedButton(
          ...
          child: const Text('تأكيد الاشتراك', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
        ),
      ),
    );
  }
